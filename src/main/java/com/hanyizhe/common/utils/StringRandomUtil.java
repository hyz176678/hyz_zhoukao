...
public class StringRandomUtil {
  ...
  /**
   * 方法4：返回中文姓名，必须以真实姓开头，百家姓在“六、附百家姓”里，名使
   * 用1-2个随机汉字(8分)，内部调用randomChineseString()方法(3分)
   * 。返回示例：“刘呀被”、“欧阳及为”
   * @return
   */
  public static String generateChineseName() {
    String[] beginName = { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "楮", "卫", "蒋", "沈", "韩", "杨",
    ...
    Integer index = RandomUtil.getRandom1(0, beginName.length - 1);
    String str = beginName[index];
    return str;
  }
}
